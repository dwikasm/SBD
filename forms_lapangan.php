...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
					<h3 class="blank1">Form Lapangan</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">ID Lapangan</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Id">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Nama Lapangan</label>
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1" id="Nama">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Harga Sewa Siang</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Siang">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Harga Sewa Malam</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Malam">
									</div>
								</div>
