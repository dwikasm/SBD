...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
					<h3 class="blank1">Form Paket</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">ID Paket</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Id">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Nama Paket</label>
									<div class="col-sm-8">
