...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
					<h3 class="blank1">Form Petugas</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">ID Petugas</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Id">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Nama Petugas</label>
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1" id="Nama">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Alamat Petugas</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Alamat">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">No Hp Petugas</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="Hp">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Password Petugas</label>
									<div class="col-sm-8">
